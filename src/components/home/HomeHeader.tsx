...
export function HomeHeader() {
  return (
    <div className="pointer-events-none absolute inset-x-0 top-0 z-10">
      {/* Progressive blur layer — iOS 26 style */}
      <div
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between px-6 pt-14">
          ...
          <div className="flex items-center gap-1.5 pointer-events-auto">
            <img src="/figma-assets/a4198387082605f2a8f9d8ad6d1d21e9ed03679f.svg" width={19} height={13} alt="" />
            <img src="/figma-assets/5f2f33dd898f106cc9bf144bc1aa9d551e751172.svg" width={17} height={13} alt="" />
            <img src="/figma-assets/61b774f95a59e641835654a61344b08c890ba989.svg" width={27} height={13} alt="" />
          </div>
        </div>
        ...
        <div className="flex items-center justify-between px-5 pt-3 pb-4 pointer-events-auto">
          ...
          <div className="relative h-[60px] w-[60px]">
            ...
            <img
              src="/figma-assets/64254c9a362710784f4d26e0ee60f1fbd57a01a4.png"
              alt="Emma"
          ...
          <div className="flex items-center gap-3">
            <GlassButton icon="/figma-assets/ae6cd94bd838b706816a5f942d2e408d0d5db389.svg" label="Chat" />
            <GlassButton icon="/figma-assets/99b283f4cd502ae5fade085645331271c893f365.svg" label="Meny" />
          </div>
        </div>
      </div>
    </div>
